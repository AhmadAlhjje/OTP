  ...
  const features = [
    {
      ...
      description: "API قوي ومرن يمكن دمجه بسهولة مع أنظمتك الحالية",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Shield />,
      title: "حماية كاملة لبياناتك وخصوصية عملائك",
      description: "تشفير متقدم وحماية شاملة لجميع البيانات المرسلة",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <Zap />,
      title: "إرسال آلاف الرسائل في ثوانٍ معدودة",
      description: "سرعة فائقة في الإرسال مع ضمان الوصول",
      color: "from-yellow-500 to-orange-500",
    },
    {
      icon: <Megaphone />,
      title: "إعلانات بدون حظر",
      description: "إرسال إعلانات دون التعرض للحظر من واتساب",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: <Bot />,
      title: "رد تلقائي ذكي",
      description: "نظام ذكي للردود التلقائية مع تخصيص كامل",
      color: "from-indigo-500 to-blue-500",
    },
    {
      icon: <Users />,
      title: "إرسال جماعي متقدم",
      description: "إرسال لآلاف المستقبلين مع إدارة ذكية للقوائم",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            اكتشف مجموعة شاملة من المميزات المتقدمة التي تجعل إرسال رسائل واتساب
            أسهل وأكثر فعالية
          </p>
        </div>

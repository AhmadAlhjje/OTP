      ...
      <div className="space-y-2">
        ...
        <div className="relative group">
          ...
          <Input
            ...
            className="w-full pl-12 pr-12 py-3.5 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 dark:bg-gray-700/50 dark:text-white transition-all duration-200 placeholder:text-gray-400 text-sm font-medium backdrop-blur-sm"
          />
          <button
            type="button"
